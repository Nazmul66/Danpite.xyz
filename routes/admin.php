...
Route::group(['prefix' => 'admin', 'middleware' => ['Is_admin', 'auth']], function () {
    ...
    Route::resource('projects', BlogpageController::class)->names('projects');
    Route::post('/project/{id}', [BlogpageController::class, 'update']);
    Route::get('projectinfo', [BlogpageController::class, 'projectedata'])->name('project.info');
    Route::put('project/status', [BlogpageController::class, 'updatestatus'])->name('updatestatus.project');
    Route::get('project/destroy/{id}', [BlogpageController::class, 'destroy']);
