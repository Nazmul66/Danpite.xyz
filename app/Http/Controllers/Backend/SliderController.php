...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $slider->slider_btn2_name =$request->slider_btn2_name;
        $slider->slider_btn2_link =$request->slider_btn2_link;
    ...
    public function sliderdata()
    {
        ...
        return Datatables::of($sliders)
            ->addColumn('action', function ($sliders) {
                return '<a href="#" type="button" id="editSliderBtn" data-id="' . $sliders->id . '"   class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editmainSlider">Edit</a>
                <a href="#" type="button" id="deleteSliderBtn" data-id="' . $sliders->id . '" class="btn btn-danger btn-sm" >Delete</a>';
            })
            ->make(true);
    }
