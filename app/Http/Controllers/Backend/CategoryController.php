...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if( $request->file('Banner_img') ){
            ...
            $category->Banner_img   = $imagePath . $imageName;
        }
        ...
        if( $request->file('meta_img') ){
            ...
            $category->meta_img   = $imagePath . $imageName;
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if( $request->file('Banner_img') ){
            ...
            if( !is_null($category->Banner_img) && file_exists($category->Banner_img) ){
                unlink($category->Banner_img);
            }
        ...
        if( $request->file('meta_img') ){
            ...
            if( !is_null($category->meta_img) && file_exists($category->meta_img) ){
                unlink($category->meta_img);
            }
    ...
    public function destroy(string $id)
    {
        ...
        if ( !is_null($category->meta_img) ) {
            if (file_exists($category->meta_img)) {
                unlink($category->meta_img);
            }
        }

        if ( !is_null($category->Banner_img) ) {
            if (file_exists($category->Banner_img)) {
                unlink($category->Banner_img);
            }
        }
