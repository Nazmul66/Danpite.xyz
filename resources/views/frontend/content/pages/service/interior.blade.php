        ...
        <div class="intro-container" id="contactcar">
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="padding-top: 100px;">
                        <div class="carousel-background"><img src="{{asset('public/frontend/img/')}}/price.jpg" alt=""></div>
                        <div class="container text-center">
                            <div class="row">
                                <div class="col-md-8" style="padding-top: 100px;">
                                    <h1 style="text-align: left; color: white; font-weight: 600; padding-left: 8%;">Best Interior Painting <br> In Bangladesh</h1>
                                    <p style="float: left; padding-left: 8%;">Stand out with the best painting service in town!</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="card" style="background: #26b7db;border-radius: 20px;color: white;">
                                        <div class="card-body">
                                            <h4 style="font-size: 27px;font-weight: 600;">Book A Free Site Visit </h4>
